...
samples1_augmented = p5_augment_with_noise(samples1, dimensions_augmented);
samples2_augmented = p5_augment_with_noise(samples2, dimensions_augmented);
samples3_augmented = p5_augment_with_noise(samples3, dimensions_augmented);
